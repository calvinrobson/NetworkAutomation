...
cisco_881 = {
    ...
    'host':   '192.168.129.139',
    'username': 'calvin',
    'password': 'password',        # optional, defaults to 22
    'secret': 'password',     # optional, defaults to ''
}

COMMANDS_LIST = [
    'show version | i Process'
    ]
COMMANDS_LIST1 = [
    'sh run | i hostname'
]
...
def main():
    ...
    with open ('test.csv', 'w', newline='') as a:
         write = csv.writer(a)
         write.writerow(['Serial', 'Device', 'three'])
         write.writerow([task.result(), task1.result()])
